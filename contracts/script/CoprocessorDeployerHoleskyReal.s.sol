...
contract CoprocessorDeployerHoleskyReal is CoprocessorDeployer {
    function run() external {
        string memory paramFile = "./script/input/deployment_parameters_holesky_real.json";
        ...
        string memory outputPath = "./script/output/coprocessor_deployment_output_holesky_real.json";

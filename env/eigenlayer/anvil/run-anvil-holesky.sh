...
STRATEGY_MANAGER=$(jq -r .strategyManager < /cartesi-lambada-coprocessor/contracts/script/input/deployment_parameters_holesky.json)
STRATEGY_ADDRESS=$(jq -r .wETH < /cartesi-lambada-coprocessor/contracts/script/input/deployment_parameters_holesky.json )
